...
class Complejo(object):
    ...
    def dividir(self, otro):
        result = Complejo((self.real*otro.real + self.imag*otro.imag)/(otro.real**2 + otro.imag**2),
                           (self.imag*otro.real - self.real*otro.imag)/(otro.real**2 + otro.imag**2))
        return result
...
class TestComplejo(unittest.TestCase):
    ...
    def test_multiplicar(self):
        ...
        self.assertEqual(multiplicar.real, 16)
        self.assertEqual(multiplicar.imag, -11)
    ...
    def test_dividir(self):
        ...
        self.assertEqual(dividir.real, -1/5)
        self.assertEqual(dividir.imag, 8/5)
